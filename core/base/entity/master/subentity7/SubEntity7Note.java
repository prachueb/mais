...
public class SubEntity7Note extends ANote implements Serializable {
    /** Creates a new instance of LanguageNote */
    public SubEntity7Note() {
    }
    ...
    public String toString() {
        return "entity.master.subentity7.subentity7Note[id=" + getId() + " order=" + getOrderId()+ "]";
    }
