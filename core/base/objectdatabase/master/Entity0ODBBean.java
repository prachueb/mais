...
import base.entity.master.entity0.Entity0Code;
import base.entity.master.entity0.Entity0ControlId;
import base.entity.master.entity0.Entity0Description;
import base.entity.master.entity0.Entity0Main;
import base.entity.master.entity0.Entity0Note;
...
/**
 * <p>
 * Title: Entity0ODBBean
 * </p>
 * <p>
 * Description: entity0 object data.
 * </p>
 * This class implements to persist entity0 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the entity0 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity0ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity0ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity0Code code;
	/**
	 * Main entity.
	 */
	private Entity0Main main;
	/**
	 * Entity0ControlId entity.
	 */
	private Entity0ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of Entity1ODDBean.
	 */
	public Entity0ODBBean() {
		super();
		...
		code = new Entity0Code();
		main = new Entity0Main();
		controlID = new Entity0ControlId();
	}

	public long size() {
		logger.fine("entity0Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity0Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity0Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity0Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity0ODBBean:assignData: " + dto.getCode());
