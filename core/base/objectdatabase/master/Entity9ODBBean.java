...
import base.entity.master.entity9.Entity9Code;
import base.entity.master.entity9.Entity9ControlId;
import base.entity.master.entity9.Entity9Description;
import base.entity.master.entity9.Entity9Main;
import base.entity.master.entity9.Entity9Note;
...
/**
 * <p>
 * Title: Entity9ODBBean
 * </p>
 * <p>
 * Description: entity9 object data.
 * </p>
 * This class implements to persist entity9 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the entity1 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity9ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity9ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity9Code code;
	/**
	 * Main entity.
	 */
	private Entity9Main main;
	/**
	 * Entity1ControlId entity.
	 */
	private Entity9ControlId controlID;
	/**
	...
	public Entity9ODBBean() {
		...
		code = new Entity9Code();
		main = new Entity9Main();
		controlID = new Entity9ControlId();
	}

	public long size() {
		logger.fine("entity9Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity9Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity9Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity9Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity9ODBBean:assignData: " + dto.getCode());
