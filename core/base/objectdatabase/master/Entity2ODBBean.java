...
import base.dto.master.EntityDTO;
import base.entity.master.entity2.Entity2Code;
import base.entity.master.entity2.Entity2ControlId;
import base.entity.master.entity2.Entity2Description;
import base.entity.master.entity2.Entity2Main;
import base.entity.master.entity2.Entity2Note;
...
/**
 * <p>
 * Title: Entity2ODBBean
 * </p>
 * <p>
 * Description: entity2 object data.
 * </p>
 * This class implements to persist entity2 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the entity2 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity2ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity2ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity2Code code;
	/**
	 * Main entity.
	 */
	private Entity2Main main;
	/**
	 * Entity2ControlId entity.
	 */
	private Entity2ControlId controlID;
	/**
	 ...
	 */
	public Entity2ODBBean() {
		super();
		// logger.setLevel(Level.INFO);

		// pInfo.setClassName(Entity2ODBBean.class.getName());

		entityDTO = new EntityDTO();
		code = new Entity2Code();
		main = new Entity2Main();
		controlID = new Entity2ControlId();
	}

	public long size() {
		logger.fine("entity2Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity2Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity2Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity2Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity2ODBBean:assignData: " + dto.getCode());
