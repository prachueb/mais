...
import base.entity.master.entity6.Entity6Code;
import base.entity.master.entity6.Entity6ControlId;
import base.entity.master.entity6.Entity6Description;
import base.entity.master.entity6.Entity6Main;
import base.entity.master.entity6.Entity6Note;
...
/**
 * <p>
 * Title: Entity6ODBBean
 * </p>
 * <p>
 * Description: Entity6 object data.
 * </p>
 * This class implements to persist Entity6 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the Entity6 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity6ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity6ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity6Code code;
	/**
	 * Main entity.
	 */
	private Entity6Main main;
	/**
	 * Entity6ControlId entity.
	 */
	private Entity6ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of Entity6ODDBean.
	 */
	public Entity6ODBBean() {
		super();
		...
		code = new Entity6Code();
		main = new Entity6Main();
		controlID = new Entity6ControlId();
	}

	public long size() {
		logger.fine("entity6Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity6Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity6Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity6Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity6ODBBean:assignData: " + dto.getCode());
