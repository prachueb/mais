...
import base.entity.master.entity4.Entity4Code;
import base.entity.master.entity4.Entity4ControlId;
import base.entity.master.entity4.Entity4Description;
import base.entity.master.entity4.Entity4Main;
import base.entity.master.entity4.Entity4Note;
...
/**
 * <p>
 * Title: Entity4ODBBean
 * </p>
 * <p>
 * Description: Entity4 object data.
 * </p>
 * This class implements to persist Entity4 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the Entity4 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity4ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity4ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity4Code code;
	/**
	 * Main entity.
	 */
	private Entity4Main main;
	/**
	 * Entity4ControlId entity.
	 */
	private Entity4ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of Entity4ODDBean.
	 */
	public Entity4ODBBean() {
		super();
		...
		code = new Entity4Code();
		main = new Entity4Main();
		controlID = new Entity4ControlId();
	}

	public long size() {
		logger.fine("entity4Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity4Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity4Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity4Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity4ODBBean:assignData: " + dto.getCode());
