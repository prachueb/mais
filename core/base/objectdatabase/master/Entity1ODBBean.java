...
import base.entity.master.entity1.Entity1Code;
import base.entity.master.entity1.Entity1ControlId;
import base.entity.master.entity1.Entity1Description;
import base.entity.master.entity1.Entity1Main;
import base.entity.master.entity1.Entity1Note;
...
/**
 * <p>
 * Title: Entity1ODBBean
 * </p>
 * <p>
 * Description: entity1 object data.
 * </p>
 * This class implements to persist entity1 information.
 * <P>
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity1ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity1ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity1Code code;
	/**
	 * Main entity.
	 */
	private Entity1Main main;
	/**
	 * Entity1ControlId entity.
	 */
	private Entity1ControlId controlID;
	/**
	...
	public Entity1ODBBean() {
		...
		code = new Entity1Code();
		main = new Entity1Main();
		controlID = new Entity1ControlId();
	}

	public long size() {
		logger.fine("entity1Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity1Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity1Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity1Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity1ODBBean:assignData: " + dto.getCode());
