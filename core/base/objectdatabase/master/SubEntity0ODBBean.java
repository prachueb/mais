...
import base.entity.master.subentity0.SubEntity0Code;
import base.entity.master.subentity0.SubEntity0ControlId;
import base.entity.master.subentity0.SubEntity0Description;
import base.entity.master.subentity0.SubEntity0Main;
import base.entity.master.subentity0.SubEntity0Note;
...
/**
 * <p>
 * Title: SubEntity0ODBBean
 * </p>
 * <p>
 * Description: subentity0 object data.
 * </p>
 * This class implements to persist subentity0 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the subentity0 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity0ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity0ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity0Code code;
	/**
	 * Main entity.
	 */
	private SubEntity0Main main;
	/**
	 * SubEntity0ControlId entity.
	 */
	private SubEntity0ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of SubEntity1ODDBean.
	 */
	public SubEntity0ODBBean() {
		super();
		// logger = Logger.getLogger("objectdb.base.SubEntity1ODDBean");
		// logger.setLevel(Level.INFO);

		// pInfo.setClassName(UserODBBean.class.getName());

		subEntityDTO = new SubEntityDTO();
		code = new SubEntity0Code();
		main = new SubEntity0Main();
		controlID = new SubEntity0ControlId();
	}

	public long size() {
		logger.fine("subEntity0Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity0Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity0Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity0Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("SubEntity0ODBBean:assignData: " + dto.getCode());
