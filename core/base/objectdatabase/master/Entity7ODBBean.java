...
import base.entity.master.entity7.Entity7Code;
import base.entity.master.entity7.Entity7ControlId;
import base.entity.master.entity7.Entity7Description;
import base.entity.master.entity7.Entity7Main;
import base.entity.master.entity7.Entity7Note;
...
/**
 * <p>
 * Title: Entity7ODBBean
 * </p>
 * <p>
 * Description: Entity7 object data.
 * </p>
 * This class implements to persist Entity8 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the Entity8 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity7ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity7ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity7Code code;
	/**
	 * Main entity.
	 */
	private Entity7Main main;
	/**
	 * Entity7ControlId entity.
	 */
	private Entity7ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of Entity7ODDBean.
	 */
	public Entity7ODBBean() {
		super();
		...
		code = new Entity7Code();
		main = new Entity7Main();
		controlID = new Entity7ControlId();
	}

	public long size() {
		logger.fine("entity7Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity7Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity7Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity7Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity7ODBBean:assignData: " + dto.getCode());
