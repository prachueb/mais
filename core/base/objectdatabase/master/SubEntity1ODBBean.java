...
import base.entity.master.subentity1.SubEntity1Code;
import base.entity.master.subentity1.SubEntity1ControlId;
import base.entity.master.subentity1.SubEntity1Description;
import base.entity.master.subentity1.SubEntity1Main;
import base.entity.master.subentity1.SubEntity1Note;
...
/**
 * <p>
 * Title: SubEntity1ODBBean
 * </p>
 * <p>
 * Description: subentity1 object data.
 * </p>
 * This class implements to persist subentity1 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the subentity1 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity1ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity1ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity1Code code;
	/**
	 * Main entity.
	 */
	private SubEntity1Main main;
	/**
	 * SubEntity1ControlId entity.
	 */
	private SubEntity1ControlId controlID;
	/**
	...
	public SubEntity1ODBBean() {
		...
		code = new SubEntity1Code();
		main = new SubEntity1Main();
		controlID = new SubEntity1ControlId();
	}

	public long size() {
		logger.fine("subEntityFacade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity1Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity1Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity1Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("SubEntity1ODBBean:assignData: " + dto.getCode());
