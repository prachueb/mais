...
import base.entity.master.entity8.Entity8Code;
import base.entity.master.entity8.Entity8ControlId;
import base.entity.master.entity8.Entity8Description;
import base.entity.master.entity8.Entity8Main;
import base.entity.master.entity8.Entity8Note;
...
/**
 * <p>
 * Title: Entity8ODBBean
 * </p>
 * <p>
 * Description: Entity8 object data.
 * </p>
...
// @Stateless
@Stateless(mappedName = "Entity8ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity8ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity8Code code;
	/**
	 * Main entity.
	 */
	private Entity8Main main;
	/**
	 * Entity8ControlId entity.
	 */
	private Entity8ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of Entity8ODDBean.
	 */
	public Entity8ODBBean() {
		super();
		...
		code = new Entity8Code();
		main = new Entity8Main();
		controlID = new Entity8ControlId();
	}

	public long size() {
		logger.fine("Entity8Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity8Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity8Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity8Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity8ODBBean:assignData: " + dto.getCode());
