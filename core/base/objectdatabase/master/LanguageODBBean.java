...
import base.dto.master.LanguageDTO;
import base.entity.master.language.LanguageCode;
import base.entity.master.language.LanguageControlId;
import base.entity.master.language.LanguageDescription;
import base.entity.master.language.LanguageMain;
import base.entity.master.language.LanguageNote;
...
/**
 * <p>
 * Title: LanguageODBBean
 * </p>
 * <p>
 * Description: Language object data.
 * </p>
 * This class implements to persist Language information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the Language tables.
 * <p>
...
public class LanguageODBBean extends AODBMBase implements LanguageODBRemote {
	 ...
	 * Main entity.
	 */
	private LanguageMain main;
	/**
	 * LanguageControlId entity.
	 */
	private LanguageControlId languageControlID;
	/**
	...
	/**
	 * Creates a new instance of LanguageODDBean.
	 */
	public LanguageODBBean() {
		super();
		...
		main = new LanguageMain();
		languageControlID = new LanguageControlId();
	}

	public long size() {
		logger.fine("LanguageFacade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM LanguageCode c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new LanguageDescription());
	}

	@Override
	protected ANote getNewNote() {
		return new LanguageNote();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("LanguageODBBean:assignData: " + dto.getCode());
