...
import base.entity.master.subentity2.SubEntity2Code;
import base.entity.master.subentity2.SubEntity2ControlId;
import base.entity.master.subentity2.SubEntity2Description;
import base.entity.master.subentity2.SubEntity2Main;
import base.entity.master.subentity2.SubEntity2Note;
...
/**
 * <p>
 * Title: SubEntity2ODBBean
 * </p>
 * <p>
 * Description: subEntity2 object data.
 * </p>
 * This class implements to persist subEntity2 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the subEntity2 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity2ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity2ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity2Code code;
	/**
	 * Main entity.
	 */
	private SubEntity2Main main;
	/**
	 * SubEntity2ControlId entity.
	 */
	private SubEntity2ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of SubEntity2ODDBean.
	 */
	public SubEntity2ODBBean() {
		super();
		// logger = Logger.getLogger("objectdb.base.subEntity2ODDBean");
		// logger.setLevel(Level.INFO);

		// pInfo.setClassName(UserODBBean.class.getName());

		subEntityDTO = new SubEntityDTO();
		code = new SubEntity2Code();
		main = new SubEntity2Main();
		controlID = new SubEntity2ControlId();
	}

	public long size() {
		logger.fine("subEntity2Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity2Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity2Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity2Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("SubEntity2ODBBean:assignData: " + dto.getCode());
