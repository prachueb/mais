...
import base.entity.master.subentity5.SubEntity5Code;
import base.entity.master.subentity5.SubEntity5ControlId;
import base.entity.master.subentity5.SubEntity5Description;
import base.entity.master.subentity5.SubEntity5Main;
import base.entity.master.subentity5.SubEntity5Note;
...
/**
 * <p>
 * Title: SubEntity5ODBBean
 * </p>
 * <p>
 * Description: SubEntity5 object data.
 * </p>
 * This class implements to persist SubEntity5 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the SubEntity5 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity5ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity5ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity5Code code;
	/**
	 * Main entity.
	 */
	private SubEntity5Main main;
	/**
	 * SubEntity5ControlId entity.
	 */
	private SubEntity5ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of SiteODDBean.
	 */
	public SubEntity5ODBBean() {
		super();
		// logger = Logger.getLogger("objectdb.base.SubEntity5ODDBean");
		// logger.setLevel(Level.INFO);

		// pInfo.setClassName(UserODBBean.class.getName());

		subEntityDTO = new SubEntityDTO();
		code = new SubEntity5Code();
		main = new SubEntity5Main();
		controlID = new SubEntity5ControlId();
	}

	public long size() {
		logger.fine("SubEntity5Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity5Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity5Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity5Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("SubEntity5ODBBean:assignData: " + dto.getCode());
