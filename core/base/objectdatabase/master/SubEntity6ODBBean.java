...
import base.entity.master.subentity6.SubEntity6Code;
import base.entity.master.subentity6.SubEntity6ControlId;
import base.entity.master.subentity6.SubEntity6Description;
import base.entity.master.subentity6.SubEntity6Main;
import base.entity.master.subentity6.SubEntity6Note;
...
/**
 * <p>
 * Title: SubEntity6ODBBean
 * </p>
 * <p>
 * Description: SubEntity6 object data.
 * </p>
 * This class implements to persist SubEntity6 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the SubEntity6 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity6ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity6ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity6Code code;
	/**
	 * Main entity.
	 */
	private SubEntity6Main main;
	/**
	 * SubEntity6ControlId entity.
	 */
	private SubEntity6ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of SubEntity6ODDBean.
	 */
	public SubEntity6ODBBean() {
		super();
		// logger = Logger.getLogger("objectdb.base.SubEntity6ODDBean");
		// logger.setLevel(Level.INFO);

		// pInfo.setClassName(UserODBBean.class.getName());

		subEntityDTO = new SubEntityDTO();
		code = new SubEntity6Code();
		main = new SubEntity6Main();
		controlID = new SubEntity6ControlId();
	}

	public long size() {
		logger.fine("SubEntity6Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity6Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity6Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity6Note();
	}
