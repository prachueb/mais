...
import base.entity.master.subentity7.SubEntity7Code;
import base.entity.master.subentity7.SubEntity7ControlId;
import base.entity.master.subentity7.SubEntity7Description;
import base.entity.master.subentity7.SubEntity7Main;
import base.entity.master.subentity7.SubEntity7Note;
...
/**
 * <p>
 * Title: SubEntity7ODBBean
 * </p>
 * <p>
 * Description: SubEntity7 object data.
 * </p>
 * This class implements to persist SubEntity7 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the SubEntity7 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity7ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity7ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity7Code code;
	/**
	 * Main entity.
	 */
	private SubEntity7Main main;
	/**
	 * SubEntity7ControlId entity.
	 */
	private SubEntity7ControlId controlID;
	/**
	...
	public SubEntity7ODBBean() {
		...
		code = new SubEntity7Code();
		main = new SubEntity7Main();
		controlID = new SubEntity7ControlId();
	}

	public long size() {
		logger.fine("SubEntity7Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity7Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity7Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity7Note();
	}
