...
import base.entity.master.subentity3.SubEntity3Code;
import base.entity.master.subentity3.SubEntity3ControlId;
import base.entity.master.subentity3.SubEntity3Description;
import base.entity.master.subentity3.SubEntity3Main;
import base.entity.master.subentity3.SubEntity3Note;
...
/**
 * <p>
 * Title: SubEntity3ODBBean
 * </p>
 * <p>
 * Description: SubEntity3 object data.
 * </p>
 * This class implements to persist SubEntity3 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the SubEntity3 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity3ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity3ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity3Code code;
	/**
	 * Main entity.
	 */
	private SubEntity3Main main;
	/**
	 * SubEntity3ControlId entity.
	 */
	private SubEntity3ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of SubEntity3ODDBean.
	 */
	public SubEntity3ODBBean() {
		super();
		// logger = Logger.getLogger("objectdb.base.SubEntity3ODDBean");
		// logger.setLevel(Level.INFO);

		// pInfo.setClassName(UserODBBean.class.getName());

		subEntityDTO = new SubEntityDTO();
		code = new SubEntity3Code();
		main = new SubEntity3Main();
		controlID = new SubEntity3ControlId();
	}

	public long size() {
		logger.fine("SubEntity3Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity3Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity3Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity3Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("SubEntity3ODBBean:assignData: " + dto.getCode());
