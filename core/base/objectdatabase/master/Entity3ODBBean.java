...
import base.entity.master.entity3.Entity3Code;
import base.entity.master.entity3.Entity3ControlId;
import base.entity.master.entity3.Entity3Description;
import base.entity.master.entity3.Entity3Main;
import base.entity.master.entity3.Entity3Note;
...
/**
 * <p>
 * Title: Entity3ODBBean
 * </p>
 * <p>
 * Description: entity3 object data.
 * </p>
 * This class implements to persist site information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the entity3 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity3ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity3ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity3Code code;
	/**
	 * Main entity.
	 */
	private Entity3Main main;
	/**
	 * Entity3ControlId entity.
	 */
	private Entity3ControlId controlID;
	/**
	...
	/**
	 * Creates a new instance of Entity3ODDBean.
	 */
	public Entity3ODBBean() {
		super();
		...
		code = new Entity3Code();
		main = new Entity3Main();
		controlID = new Entity3ControlId();
	}

	public long size() {
		logger.fine("entity3Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity3Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity3Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity3Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity3ODBBean:assignData: " + dto.getCode());
