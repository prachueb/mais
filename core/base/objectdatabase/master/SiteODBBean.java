...
import base.dto.master.SiteDTO;
import base.entity.master.site.SiteCode;
import base.entity.master.site.SiteControlId;
import base.entity.master.site.SiteDescription;
import base.entity.master.site.SiteMain;
import base.entity.master.site.SiteNote;
 ...
 * for easy using.
 * </p>
 * It served as gateway to access all the site tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SiteODBBean/remote")
@Remote({ SiteODBRemote.class })
public class SiteODBBean extends AODBMBase implements SiteODBRemote {
	 ...
	 * Main entity.
	 */
	private SiteMain main;
	/**
	 * SiteControlId entity.
	 */
	private SiteControlId siteControlID;
	/**
	...
	public SiteODBBean() {
		...
		code = new SiteCode();
		main = new SiteMain();
		siteControlID = new SiteControlId();
	}

	public long size() {
		logger.fine("siteFacade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM siteCode c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SiteDescription());
	}
