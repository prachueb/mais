...
import base.entity.master.subentity9.SubEntity9Code;
import base.entity.master.subentity9.SubEntity9ControlId;
import base.entity.master.subentity9.SubEntity9Description;
import base.entity.master.subentity9.SubEntity9Main;
import base.entity.master.subentity9.SubEntity9Note;
...
/**
 * <p>
 * Title: SubEntity9ODBBean
 * </p>
 * <p>
 * Description: subentity9 object data.
 * </p>
 * This class implements to persist subentity9 information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the subentity9 tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "SubEntity9ODBBean/remote")
@Remote({ SubEntityODBRemote.class })
public class SubEntity9ODBBean extends AODBMBase implements SubEntityODBRemote {
	 ...
	 * Code entity.
	 */
	private SubEntity9Code code;
	/**
	 * Main entity.
	 */
	private SubEntity9Main main;
	/**
	 * SubEntity1ControlId entity.
	 */
	private SubEntity9ControlId controlID;
	/**
	...
	public SubEntity9ODBBean() {
		...
		code = new SubEntity9Code();
		main = new SubEntity9Main();
		controlID = new SubEntity9ControlId();
	}

	public long size() {
		logger.fine("subEntity9Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM SubEntity9Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new SubEntity9Description());
	}

	@Override
	protected ANote getNewNote() {
		return new SubEntity9Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("SubEntity9ODBBean:assignData: " + dto.getCode());
