...
import base.entity.master.entity5.Entity5Code;
import base.entity.master.entity5.Entity5ControlId;
import base.entity.master.entity5.Entity5Description;
import base.entity.master.entity5.Entity5Main;
import base.entity.master.entity5.Entity5Note;
...
/**
 * <p>
 * Title: Entity5ODBBean
 * </p>
 * <p>
 * Description: Entity5 object data.
 * </p>
 * This class implements to persist Entity5 information.
 * <P>
 * <p>
...
// @Stateless
@Stateless(mappedName = "Entity5ODBBean/remote")
@Remote({ EntityODBRemote.class })
public class Entity5ODBBean extends AODBMBase implements EntityODBRemote {
	 ...
	 * Code entity.
	 */
	private Entity5Code code;
	/**
	 * Main entity.
	 */
	private Entity5Main main;
	/**
	 * Entity5ControlId entity.
	 */
	private Entity5ControlId controlID;
	/**
	...
	public Entity5ODBBean() {
		...
		code = new Entity5Code();
		main = new Entity5Main();
		controlID = new Entity5ControlId();
	}

	public long size() {
		logger.fine("Entity5Facade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM Entity5Code c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new Entity5Description());
	}

	@Override
	protected ANote getNewNote() {
		return new Entity5Note();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("Entity5ODBBean:assignData: " + dto.getCode());
