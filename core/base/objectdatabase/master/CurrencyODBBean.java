...
import base.dto.master.CurrencyDTO;
import base.entity.master.currency.CurrencyCode;
import base.entity.master.currency.CurrencyControlId;
import base.entity.master.currency.CurrencyDescription;
import base.entity.master.currency.CurrencyMain;
import base.entity.master.currency.CurrencyNote;
...
/**
 * <p>
 * Title: CurrencyODBBean
 * </p>
 * <p>
 * Description: currency object data.
 * </p>
 * This class implements to persist currency information.
 * <P>
 * <p>
 * Converting from internal entity code as long to the string entity code in DTO
 * for easy using.
 * </p>
 * It served as gateway to access all the currency tables.
 * <p>
...
// @Stateless
@Stateless(mappedName = "CurrencyODBBean/remote")
@Remote({ CurrencyODBRemote.class })
public class CurrencyODBBean extends AODBMBase implements CurrencyODBRemote {
	...
	/**
	 * CurrencyControlId entity.
	 */
	private CurrencyControlId currencyControlID;
	/**
	...
	/**
	 * Creates a new instance of CurrencyODDBean.
	 */
	public CurrencyODBBean() {
		super();
		// logger = Logger.getLogger("objectdb.base.CurrencyODDBean");
		...
		main = new CurrencyMain();
		currencyControlID = new CurrencyControlId();
	}

	public long size() {
		logger.fine("currencyFacade:find");

		Query query;
		Object result;
		try {
			query = em.createQuery("SELECT COUNT(c) FROM CurrencyCode c");
	...
	protected ADescription getNewLingualDescription() {
		return (ADescription) (new CurrencyDescription());
	}

	@Override
	protected ANote getNewNote() {
		return new CurrencyNote();
	}
	...
	protected DTO assignData(ACode c, AMain m, DTO dto) {
		logger.fine("CurrencyODBBean:assignData: " + dto.getCode());
