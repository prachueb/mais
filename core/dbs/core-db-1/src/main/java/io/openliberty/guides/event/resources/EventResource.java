...
public class EventResource {
    ...
    public String hello() {
        ...
        try {
            System.out.println("Hello in EventResource and eventDAO is " + eventDAO);

            return "Hello in EventResource and eventDAO is " + eventDAO;
        } catch (Exception e) {
//      e.printStackTrace();
            return "Error in EventResource::hello ";
        }
    }
