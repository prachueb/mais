...
//	@TransactionAttribute(TransactionAttributeType.REQUIRED)
	...
	/**
	 * To read data of the persistence.
	 * The statement "super.read(connectionInfo, data);"
	 * should be declare.
	 * Local and remote interfaces should be done for EJB calling.
	 * @param connectionInfo
	 * @param data
	 ...
	 * @throws ODBException
	 */
	abstract public DTO read(Connection connectionInfo, DTO data)
			throws ODBException;

	/**
	 * To read short data in the ACode of the persistence.
	 * The statement "super.read(connectionInfo, data);"
	 * should be declare.
	 * Local and remote interfaces should be done for EJB calling.
	 * @param connectionInfo
	 ...
	 * @throws ODBException
	 */
	abstract public DTO readShort(Connection connectionInfo, DTO data)
			throws ODBException;
